...
WebUI.verifyElementText(findTestObject('Page_Main/div_already added'),'already added')

WebDriver driver=DriverFactory.getWebDriver()

WebElement Table=driver.findElement(By.xpath('//*[@id="navbarSupportedContent"]/ul/li[2]/a'))

List<WebElement> Elements =Table.findElements(By.tagName('span'))

println('No. of elements: '+Elements.size())

'Compare the value'

WebUI.verifyEqual(1, Elements.size())
