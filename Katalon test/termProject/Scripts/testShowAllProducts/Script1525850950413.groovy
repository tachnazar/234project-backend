...
WebUI.click(findTestObject('Page_Main/a_Products'), FailureHandling.STOP_ON_FAILURE)

WebDriver driver=DriverFactory.getWebDriver()

WebElement Table=driver.findElement(By.xpath('/html/body/app-root/app-product-list/div/div[2]/div'))

List<WebElement> Elements =Table.findElements(By.tagName('a'))

println('No. of elements: '+Elements.size())

'Compare the value'

WebUI.verifyEqual(5, Elements.size())
